...
"""Ansible module for querying CiliumClusterwideNetworkPolicy resources."""
...
DOCUMENTATION = r"""
---
module: cilium_clusterwide_network_policy_info
short_description: Query CiliumClusterwideNetworkPolicy resources
description:
  - Retrieve information about CiliumClusterwideNetworkPolicy custom resources.
  - Can return a single policy by name or list all cluster-wide policies.
version_added: "1.0.0"
author:
...
options:
  name:
    description:
      - Name of a specific policy to retrieve.
      - If omitted, all cluster-wide policies are returned.
    type: str
  label_selector:
    description:
...
EXAMPLES = r"""
- name: List all cluster-wide network policies
  stevefulme1.cilium.cilium_clusterwide_network_policy_info: {}
  register: policies

- name: Get a specific cluster-wide policy
  stevefulme1.cilium.cilium_clusterwide_network_policy_info:
...
- name: Filter by label
  stevefulme1.cilium.cilium_clusterwide_network_policy_info:
    label_selector: "policy-type=security"
  register: security_policies
"""

RETURN = r"""
resources:
  description: List of CiliumClusterwideNetworkPolicy resources.
  type: list
  elements: dict
  returned: always
"""
