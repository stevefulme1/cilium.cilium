...
"""Ansible module for querying CiliumEgressGatewayPolicy resources."""
...
DOCUMENTATION = r"""
---
module: cilium_egress_gateway_policy_info
short_description: Query CiliumEgressGatewayPolicy resources
description:
  - Retrieve information about CiliumEgressGatewayPolicy custom resources.
  - Egress gateway policies route traffic from selected pods through designated gateway nodes.
version_added: "1.0.0"
author:
...
options:
  name:
    description:
      - Name of a specific CiliumEgressGatewayPolicy to retrieve.
      - If omitted, all egress gateway policies are returned.
    type: str
  label_selector:
    description:
...
EXAMPLES = r"""
- name: List all egress gateway policies
  stevefulme1.cilium.cilium_egress_gateway_policy_info:
  register: policies

- name: Get a specific egress gateway policy
  stevefulme1.cilium.cilium_egress_gateway_policy_info:
...
- name: Filter policies by label
  ...
  register: platform_policies
"""

RETURN = r"""
resources:
  description: List of CiliumEgressGatewayPolicy resources.
  type: list
  elements: dict
  returned: always
"""
