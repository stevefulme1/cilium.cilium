...
"""Ansible module for querying CiliumBGPPeeringPolicy resources."""
...
DOCUMENTATION = r"""
---
module: cilium_bgp_peering_policy_info
short_description: Query CiliumBGPPeeringPolicy resources
description:
  - Retrieve information about CiliumBGPPeeringPolicy custom resources.
  - BGP peering policies configure BGP routing for Cilium nodes.
version_added: "1.0.0"
author:
...
options:
  name:
    description:
      - Name of a specific CiliumBGPPeeringPolicy to retrieve.
      - If omitted, all BGP peering policies are returned.
    type: str
  label_selector:
    description:
...
EXAMPLES = r"""
- name: List all BGP peering policies
  stevefulme1.cilium.cilium_bgp_peering_policy_info:
  register: policies

- name: Get a specific BGP peering policy
  stevefulme1.cilium.cilium_bgp_peering_policy_info:
    name: bgp-peering
  register: policy
...
- name: Filter policies by label
  ...
  register: prod_policies
"""

RETURN = r"""
resources:
  description: List of CiliumBGPPeeringPolicy resources.
  type: list
  elements: dict
  returned: always
"""
